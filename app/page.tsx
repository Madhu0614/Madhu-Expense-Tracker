        ...
        <Card className="bg-white border border-gray-200 shadow-lg">
          <CardHeader className="pb-4">
            ...
            >
              <CardTitle className="flex items-center gap-3 text-gray-900">
                <motion.div
                  className="p-2 rounded-xl bg-gradient-to-br from-blue-500/10 to-purple-500/10 border border-blue-200"
              ...
              <motion.div
                className="flex items-center gap-2 text-gray-500 hover:text-gray-700 cursor-pointer group"
                whileHover={{ x: 5 }}
          ...
          <CardContent className="space-y-3">
            {latestExpenses.length > 0 ? (
              <div className="space-y-3">
                {latestExpenses.map((expense, index) => (
                  <motion.div
                    ...
                    className="group flex items-center justify-between p-4 rounded-2xl bg-gray-50 hover:bg-gray-100 border border-gray-200 hover:border-gray-300 transition-all duration-300 cursor-pointer"
                  >
                    ...
                    <div className="flex items-center gap-4">
                      <Badge
                        variant="secondary"
                        className={`${getCategoryColor(expense.category)} backdrop-blur-sm font-medium`}
                      >
                        {expense.category}
                      </Badge>
                      <motion.p 
              ...
              >
                <motion.div
                  className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-br from-blue-500/10 to-purple-500/10 flex items-center justify-center border border-blue-200"
                  animate={{ scale: [1, 1.1, 1] }}
                  transition={{ duration: 2, repeat: Infinity }}
                >
                  <Calendar className="h-8 w-8 text-gray-400" />
                </motion.div>
                <p className="text-gray-700 text-lg font-medium">No expenses found</p>
